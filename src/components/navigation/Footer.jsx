    ...
    <section className="footer">
      <div className="footer__contact">
        <div className="footer__contact__text">
          ...
          <p className='heads-up'>We’ll give you a heads up on new Lumin products, deals, and events, plus tips & tricks on how to keep your skin looking its damned finest.</p>

          <div className="email">
            <form action="" method="post">
              <input type="email" name="email" placeholder="EMAIL ADDRESS" className="email" />
            </form>
          </div>
        </div>
